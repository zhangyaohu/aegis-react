...
const webpackConfigBase = {
  ...
  resolve: {// 减少后缀
    ...
    // ],
    alias: { // 减少使用别名提高编译速速
      '@actions': path.join(__dirname, '../store/actionCreator'),
      '@components': path.join(__dirname, '../src/components'),
      '@images': path.join(__dirname, '../src/images'),
      '@pages': path.join(__dirname, '../src/pages'),
      '@styles': path.join(__dirname, '../src/common/styles'),
      'react-dom': devMode ? '@hot-loader/react-dom' : 'react-dom', // react-hot-loader需要
      '@reg': path.join(__dirname, '../src/common/reg/regx.js'),
      '@http': path.join(__dirname, '../src/http/http.js'),
