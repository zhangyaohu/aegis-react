...
router.get('/list', async function(req, res) {
	var param = req.query, 
	sql = 'select * from sqlsummary where';
	sqlCount = 'select count(*)as total from sqlsummary where',
	sqlStr = '',
	direction = 'asc', orderBy= 'gmt_create', arg = [];
	if(param.sql_id && param.sql_id !== '') {
		sqlStr+=` and sql_id='${param.sql_id}'`
	}
...
router.get('/sql-rpt/list', async function(req, res) {
	var param = req.query, 
	sql = 'select * from sqlsummaryrpt where';
	sqlCount = 'select count(*)as total from sqlsummaryrpt where',
	sqlStr = '',
	direction = 'asc', orderBy= 'gmt_create', arg = [];
	if(param.sql_id && param.sql_id !== '') {
		sqlStr+=` and sql_id='${param.sql_id}'`
...
router.get('/sql-bind/list', async function(req, res) {
	var param = req.query, 
	sql = 'select * from sqlbind where';
	sqlCount = 'select count(*)as total from sqlbind where',
	sqlStr = '',
	direction = 'asc', orderBy= 'gmt_create', arg = [];
	if(param.sql_id && param.sql_id !== '') {
		sqlStr+=` and sql_id='${param.sql_id}'`
