...
router.get('/list', async function(req, res) {
	var param = req.query, 
	sql = 'select * from tabmon_inds where',
	sqlCount = 'select count(*) as total from tabmon_inds where',
	sqlStr = '';
...
router.get('/record/list', async function(req, res) {
	var param = req.query, 
	sql = 'select * from tabmon_sum where',
	sqlCount = 'select count(*) as total from tabmon_sum where',
	sqlStr = '';
	direction = 'asc', orderBy= 'gmt_create', arg = [];
	if(param.service && param.service !== '') {
		sqlStr+=` and service='${param.service}'`
